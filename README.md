...
Built using AI-assisted development for ideation, documentation, and occasional refactoring suggestions. All core implementation, testing, and final decisions were done manually by the author.

## Features

- Spreadsheet in/out (Excel files)
- DuckDB-powered SQL transformations
- Automatic dependency detection via `{{ ref('name') }}`
- Built-in schema tests (not_null, unique, accepted_values, etc.)
